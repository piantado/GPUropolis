...
main.o: src/main.cu src/misc.cu src/bayes.cu src/hypothesis.cu src/programs.cu src/kernels/MH-kernel.cu src/kernels/MH-weighted-kernel.cu src/kernels/MH-adaptive-anneal.cu src/kernels/prior-kernel.cu src/kernels/search-kernel.cu src/hypothesis-array.cu src/virtual-machine.cu src/data.cu
